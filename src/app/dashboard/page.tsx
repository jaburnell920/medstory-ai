...
export default function Dashboard() {
  ...
  const linkClass = "text-gray-200 hover:text-orange-300 hover:underline transition-all duration-200";
  ...
  <nav className="flex flex-col space-y-6 text-sm">
    ...
    <div>
      ...
      <ul className="ml-4 space-y-1 text-gray-200">
        <li>
          <Link className={linkClass} href="/scientific-investigation/landmark-publications">Find landmark publications</Link>
        </li>
        <li>
          <Link className={linkClass} href="/scientific-investigation/top-publications">Top N most important publications</Link>
        </li>
        <li>
          <Link className={linkClass} href="/scientific-investigation/thought-leaders">Top N most important thought leaders</Link>
        </li>
        <li>
    ...
    <div>
      ...
      <ul className="ml-4 space-y-1 text-gray-200">
        <li>
          <Link className={linkClass} href="/stakeholder-interviews/questions">Suggested questions for thought leader interviews</Link>
        </li>
        <li>
          <Link className={linkClass} href="/stakeholder-interviews/analyze-transcript">Analyze thought leader interview transcript</Link>
        </li>
        <li>
          <Link className={linkClass} href="/stakeholder-interviews/simulated-interview">Simulated thought leader interview</Link>
        </li>
        <li>
          <Link className={clsx(linkClass, 'text-blue-300')} href="/scientific-investigation/more">More...</Link>
        </li>
      ...
      <ul className="ml-4 space-y-1 text-gray-200">
        <li>
            <Link
              ...
              className={clsx(
                linkClass,
                pathname === '/dashboard' && selectedLinkClass
              )}
            >
        ...
        <li>
          <Link className={linkClass} href="/core-story-concept/optimization">Core Story Concept optimization</Link>
        </li>
        <li>
          <Link className={linkClass} href="/core-story-concept/evaluation">Core Story Concept evaluation</Link>
        </li>
        <li>
          <Link className={clsx(linkClass, 'text-blue-300')} href="/scientific-investigation/more">More...</Link>
        </li>
    ...
    <div>
      ...
      <ul className="ml-4 space-y-1 text-gray-200">
        <li>
          <Link className={linkClass} href="/story-flow-map/tension-resolution-generation">Tension-Resolution Point generation</Link>
        </li>
        <li>
          <Link className={linkClass} href="/story-flow-map/tension-resolution-optimization">Tension-Resolution Point optimization</Link>
        </li>
        <li>
          <Link className={linkClass} href="/story-flow-map/generation-optimization">Story Flow Map generation & optimization</Link>
        </li>
        <li>
          <Link className={clsx(linkClass, 'text-blue-300')} href="/scientific-investigation/more">More...</Link>
        </li>
    ...
    <div>
      ...
      <ul className="ml-4 space-y-1 text-gray-200">
        <li>
          <Link className={linkClass} href="/slide-presentation/deck-generation">MEDSTORY deck generation</Link>
        </li>
        <li>
          <Link className={linkClass} href="/slide-presentation/deck-optimization">MEDSTORY deck optimization</Link>
        </li>
        <li>
   ...
   Sign out
      ...
      <main className="flex-1 bg-gray-50 p-12">
        ...
        <p className="text-sm text-gray-600 mb-10">
          <strong>MEDSTORYmake</strong> can generate 1 to 5 Core Story Concept candidates—the big idea, the moral of your story—that you want to communicate to target audiences.
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            <p className="text-sm text-gray-600">Please provide the following information in order to proceed:</p>
            <div>
            ...
            <div>
              <label className="block font-bold mb-1 text-gray-800">Intensity of emotion/creativity</label>
              <select
                name="intensity"
          ...
          <div className="flex-1 space-y-6">
            ...
            {result && (
              ...
              <div className="flex justify-end space-x-4 mt-4">
                <button className="px-4 py-2 border border-blue-600 text-blue-600 font-semibold rounded hover:bg-blue-50 transition"   onClick={saveResult}
                >
                  Save
                </button>
